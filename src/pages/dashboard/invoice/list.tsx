...
export default function InvoiceListPage() {
  ...
  const TABS = [
    ...
    { value: 'paid', label: 'Payées', color: 'success', count: getLengthByStatus('paid') },
    { value: 'unpaid', label: 'Impayées', color: 'warning', count: getLengthByStatus('unpaid') },
    { value: 'overdue', label: 'En retard', color: 'error', count: getLengthByStatus('overdue') },
    { value: 'draft', label: 'Brouillon', color: 'default', count: getLengthByStatus('draft') },
  ] as const;
  ...
  return (
    <>
      <Head>
        <title>Mes factures - Binary-Cloud</title>
      </Head>
