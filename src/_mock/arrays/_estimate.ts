...
export const _estimates = [...Array(20)].map((_, index) => ({
  id: _mock.id(index),
  estimateNumber: `${17048 + index}`,
  taxes: 5,
  discount: 10,
...
export const _estimateAddressFrom = [...Array(5)].map((_, index) => ({
  id: _mock.id(index),
  name: _mock.name.fullName(index),
  address: _mock.address.fullAddress(index),
  company: _mock.company(index),
...
export const _estimateAddressTo = [...Array(16)].map((_, index) => ({
  id: _mock.id(index + 1),
  name: _mock.name.fullName(index + 1),
  address: _mock.address.fullAddress(index + 1),
  company: _mock.company(index + 1),
